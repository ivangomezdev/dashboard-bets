...
const RESULT_OVERRIDES = new Map([
  ...
  [
    ...
    {
      totalStakeMxn: 3864.6,
      profitMxn: -1932.3,
      profitUsd: -114,
      payoutMxn: 1932.3,
      reason: "Pinnacle VPS2 fue la pierna perdedora por 114 USD; BetFury VPS5 fue la contraparte. Stakes equilibrados a 114 USD/USDT"
    }
  ],
  [
    "1788032042075-d0911n",
    {
      totalStakeMxn: 1118.7,
      profitMxn: -561.66,
      profitUsd: -33,
      payoutMxn: 557.04,
      reason: "Pinnacle VPS2 perdió 33 USD; BetFury VPS3 quedó void. Stakes equilibrados a 33 USD/USDT"
    }
  ]
]);
...
const LEG_CORRECTIONS = new Map([
  ...
  [
    "1788051937752-leo1vi",
    {
      winningLegIndex: 1,
      overrides: [
        { legIndex: 0, stake: 114, currency: "USD", outcome: "lost", status: "USER_CONFIRMED_LOST" },
        { legIndex: 1, stake: 114, currency: "USDT", outcome: "won", status: "USER_CONFIRMED_WON" }
      ],
      reason: "Pinnacle VPS2 perdió 114 USD; BetFury VPS5 fue la contraparte ganadora"
    }
  ],
  [
    "1788032042075-d0911n",
    {
      winningLegIndex: -1,
      overrides: [
        { legIndex: 0, stake: 33, currency: "USD", outcome: "lost", status: "USER_CONFIRMED_LOST" },
        { legIndex: 1, stake: 33, currency: "USDT", outcome: "void", status: "USER_CONFIRMED_VOID" }
      ],
      reason: "Pinnacle VPS2 perdió 33 USD; BetFury VPS3 quedó void"
    }
  ]
]);
